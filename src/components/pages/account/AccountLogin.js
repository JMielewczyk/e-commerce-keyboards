        ...
        <StyledAccountLogin>
            <div className='account-wrapper'>
                ...
                <form onSubmit={handleSubmit} className='form' >
                    <label htmlFor='login'>
                        Email address
                        <input autoComplete="off" onChange={handleInputLogin} value={loginValue} type='email' id='login' placeholder='ex. Email@myemail.com'></input>
                    </label>
                    <label htmlFor='password'>
                        Password
                        <input onChange={handleInputPassword} value={passwordValue}  type='password' id='password'></input>
                    </label>
